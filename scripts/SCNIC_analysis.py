...
def main():
    ...
    make_modules = subparsers.add_parser("within", help="Make modules on a network",
                                        formatter_class=argparse.ArgumentDefaultsHelpFormatter)
    ...
    within_corr.add_argument("--sparcc_filter", help="filter as described in SparCC paper", default=False,
                             action="store_true")
    within_corr.add_argument("--sparcc_p", help="Calculate p-value for sparCC R value")
    ...
    make_modules.add_argument("--min_p", help="minimum p-value to determine edges", type=float)
